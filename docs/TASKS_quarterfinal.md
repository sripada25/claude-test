...
| T1.9 | `oauth_states` table | T1.6 | ✅ | Required by T4.1 — state/PKCE storage (L075). Depends on T1.6, not T1.2 — reuses T1.6's `oauth_provider` enum (corrected while scoping T1.9) |
